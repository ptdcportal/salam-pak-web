...
export class AccomodationCategoryComponent implements OnInit, AfterContentChecked {
  ...
  getAccomodationsListing(pageSize: any) {
    ...
    this.eventService.getAllPTDCAccomodations(queryString).subscribe((res) => {
  ...
  getAllPTDCAccomodationsListing(params: any) {
    ...
    this.eventService.getAllPTDCAccomodations(param).subscribe((res) => {

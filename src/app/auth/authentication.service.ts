...
export class AuthenticationService {
  ...
  signUp(context: any): Observable<any> {
    return this.httpClient.post(routes.signUp(), context).pipe(map((body: any) => body.data));
  }

  forgotPassword(context: any): Observable<any> {
    return this.httpClient.post(routes.forgotPassword(), context).pipe(map((body: any) => body.data));
  }
  /**

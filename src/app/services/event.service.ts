...
const routes = {
  ...
  accomodationCategories: () => `/category?categoryType=accomodation&pageSize=6`,
...
export class EventService {
  ...
  getHomeFeaturedEvents(durationTo?: number): Observable<any> {
    return this.httpClient.get(routes.getHomeFeaturedEvents(durationTo)).pipe(map((body: any) => body.data));
  }
  ...
  getCategories() {
    return this.httpClient.get(routes.categories()).pipe(map((body: any) => body.data));
  }
  ...
  getUserWishList(userId: any) {
    return this.httpClient.get(`${environment.serverUrl}/user/wishlist/${userId}`);
  }
  ...
  removeFromWishlist(locationId: any) {
    return this.httpClient.put(`${environment.serverUrl}/user/wishlist/remove`, { locationId });
  }

  removeTripFromWishlist(tripId: any) {
    return this.httpClient.put(`${environment.serverUrl}/user/wishlist/remove`, { tripId });
  }

  removeEventFromWishlist(eventId: any) {
    return this.httpClient.put(`${environment.serverUrl}/user/wishlist/remove`, { eventId });
  }

  addToWishlist(locationId: any) {
    return this.httpClient.post(`${environment.serverUrl}/user/wishlist`, { locationId });
  }

  addTripToWishlist(tripId: any) {
    return this.httpClient.post(`${environment.serverUrl}/user/wishlist`, { tripId });
  }

  addEventToWishlist(eventId: any) {
    return this.httpClient.post(`${environment.serverUrl}/user/wishlist`, { eventId });
  }

  addAccommodationToWishlist(accommodationId: any) {
    return this.httpClient.post(`${environment.serverUrl}/user/wishlist`, { accommodationId });
  }

  deleteAccommodationFromWishlist(accommodationId: any) {
    return this.httpClient.put(`${environment.serverUrl}/user/wishlist/remove`, { accommodationId });
  }

  getAccomodationsListing(params: string): Observable<any> {
    // debugger;
  ...
  getAllPTDCAccomodations(params: any): Observable<any> {
    return this.httpClient.get(routes.accomodations(params));
  }
  getUserPlan(userId: string): Observable<any> {
    return this.httpClient.get(routes.plan(userId)).pipe(map((body: any) => body.data));
  }

  removeFromPlan(locationId: any): Observable<any> {
    return this.httpClient.put(`${environment.serverUrl}/user/plan/remove`, { locationId });
  }

  removeTripFromPlan(tripId: any): Observable<any> {
    return this.httpClient.put(`${environment.serverUrl}/user/plan/remove`, { tripId });
  }

  removeEventFromPlan(eventId: any): Observable<any> {
    return this.httpClient.put(`${environment.serverUrl}/user/plan/remove`, { eventId });
  }

  addToPlan(locationId: any): Observable<any> {
    return this.httpClient.post(`${environment.serverUrl}/user/plan`, { locationId });
  }

  addTripToPlan(tripId: any): Observable<any> {
    return this.httpClient.post(`${environment.serverUrl}/user/plan`, { tripId });
  }

  addEventToPlan(eventId: any): Observable<any> {
    return this.httpClient.post(`${environment.serverUrl}/user/plan`, { eventId });
  }

  removeAccommodationFromPlan(accommodationId: any): Observable<any> {
    return this.httpClient.put(`${environment.serverUrl}/user/plan/remove`, { accommodationId });
  }
  ...
  getTripDetail(id: number) {
    ...
    return this.httpClient.get(routes.getTripDetail(id)).pipe(map((body: any) => body.data));
  }
  getAccomodationCategories(): Observable<any> {
    return this.httpClient.get(routes.accomodationCategories()).pipe(map((body: any) => body.data));
  }
  searchAccomodations(params: string): Observable<any> {
    return this.httpClient.get(routes.accomodations1(params)).pipe(map((body: any) => body.data));
  }
  getSingleAccomodationCategoryDetail(id: string) {
    // debugger;
    return this.httpClient.get(routes.singleAccomodationCategory(id)).pipe(map((body: any) => body.data));
  }
  getRoomDetail(id: string) {
    return this.httpClient.get(routes.room(id)).pipe(map((body: any) => body.data));
  }
  ...
  bookFlight(data: any) {
    return this.httpClient.post(`${environment.serverUrl}/airline/bookings`, data).pipe(map((body: any) => body.data));
  }

  bookBus(data: any) {
    return this.httpClient.post(`${environment.serverUrl}/bus/bookings`, data).pipe(map((body: any) => body.data));
  }
  ...
  getPressRelease() {
    return this.httpClient.get(`${environment.serverUrl}/press-release?skip=0&pageSize=0`);
  }

  getMedia() {
    return this.httpClient.get(`${environment.serverUrl}/media?skip=0&pageSize=0`);
  }
  ...
  getEventDetail(id: number) {
    // https://www.findmyadventure.pk/api/v2/events/?autoId=2762&trimmedSlug=rent-a-cycle-in-karachi
    return this.httpClient.get(routes.getEventDetail(id)).pipe(map((body: any) => body.data));
  }

  getRelatedEvents = (id: any) => {
    return this.httpClient.get(routes.getRelatedEvents(id)).pipe(map((body: any) => body.data));
  };
  ...
  getPlanDetails(planId: any) {
    return this.httpClient.get(routes.getPlanDetails(planId)).pipe(map((body: any) => body.data));
  }
  ...
  deleteAPlan(planId: any) {
    return this.httpClient.delete(`${environment.serverUrl}/plans/${planId}/remove`);
  }
  ...
  placeBookMeOrder(data: any) {
    return this.httpClient.post(`${environment.serverUrl}/placeOrder`, data).pipe(map((body: any) => body.data));
  }
}

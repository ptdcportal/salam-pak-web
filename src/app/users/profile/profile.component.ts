...
export class ProfileComponent implements OnInit {
  ...
  updateProfile() {
    // api
    this.userService
      .updateProfile(localStorage.getItem('userId'), this.userProfile.value)
      .subscribe(
        (res) => {
  ...
  setFeilds() {
    ...
    this.userProfile
      .get('middleName')
      .setValue(this.userData.profile.middleName);
    ...
    this.userProfile
      .get('emergencyMobile')
      .setValue(this.userData.profile.emergencyMobile);
  ...
  onSelectFile(event: any) {
    ...
    this.userService
      .changeProfilePhoto(localStorage.getItem('userId'), formData)
      .subscribe(
        (res: any) => {
          // console.log(res);

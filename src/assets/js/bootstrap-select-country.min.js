var countrypicker = (function (a) {
  ...
  var A = {
      ...
      getAlpha2Code: function (a, S) {
        try {
          var n,
            I = e[S.toLowerCase()];
          for (n in I)
            if (I.hasOwnProperty(n) && I[n].toLowerCase() === a.toLowerCase())
              return n;
          return;
        } catch (a) {
          return;
      ...
      isValid: function (a) {
        return (
          t.hasOwnProperty(a) || I.hasOwnProperty(a) || O.hasOwnProperty(a)
        );
      },
    },
    C = {
        ...
        I
          ? (a.each(t, function (a, S) {
            ...
            e.on('loaded.bs.select change', function (S) {
              ...
              e.removeClass().addClass('filter-option pull-left'),
                1 === n.length &&
